...
const api = {
  ...
  getPermissionProfiles: () => ipcRenderer.invoke("studio:getPermissionProfiles"),
  setPermissionProfiles: (store) => ipcRenderer.invoke("studio:setPermissionProfiles", store),
  pickPermissionRoot: () => ipcRenderer.invoke("studio:pickPermissionRoot"),
