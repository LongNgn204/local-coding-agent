// Local Codex Studio — dev launcher.
...
async function main() {
  ...
  // vite/bin/vite.js is not exposed via the package "exports" map, so resolve
  // it relative to the (exported) package.json instead of require.resolve'ing
